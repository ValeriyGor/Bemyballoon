    ...
    $(document).ready(function() {
        $(function() {
          $(".modal-nav-list").swipe( {
            ...
            //     $(this).animate({'margin-left':'-330px'},100); // Этот блок только для англ версии
            //     // $(this).fadeOut(300);
            //     $(".top-header__overlay").fadeOut(100);  
            //  }
            swipeRight:function(event, direction) {
                $(this).animate({'margin-right':'-300px'},100);
                // $(this).fadeOut(300);
                $(".top-header__overlay").fadeOut(100);  
             }
          });
        ...
        $( window ).resize(function() {
         ...
         $.fn.AddXbutton = function(e) {
          ...
          if ($(window).width() <= '767'){
            ...
            $("ul.navbar-nav.mr-auto .top-header__languages").prependTo(".top-header__dropdowns"), $("ul.navbar-nav.mr-auto .top-header__currency").prependTo(".top-header__dropdowns"), $(".modal-nav-list").fadeIn(100), $(".modal-nav-list").animate({'margin-left':'-15px'},100), $(".modal-nav-list").animate({'margin-right':'0'},100), $(".top-header__overlay").fadeIn(100), $("body, html").addClass("show-menu"), $(document).mouseup(function(e) {
