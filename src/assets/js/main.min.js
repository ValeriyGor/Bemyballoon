        ...
        $( window ).resize(function() {
         ...
         $.fn.AddXbutton = function(e) {
            ...
            var o = $(this),
                ...
                a = $("#mobile-category"),
                n = a.find("> ul");
            o.hasClass("active") || (o.addClass("active"), $(".burger").addClass('open'), a.addClass("relative"), n.addClass("mobile_list"), t.addClass("open"), $("body .overlay").show(), n.stop().slideDown(300), $("body").addClass("show-category"), $(document).mouseup(function(e) {
                0 === $(".mobile-category-menu").has(e.target).length && n.stop().slideUp(300, function() {
                    o.removeClass("active"), $(".burger").removeClass('open'), a.removeClass("relative"), n.removeClass("mobile_list"), t.removeClass("open"), $("body .overlay").hide(), $("body").removeClass("show-category")
                })
            }))
        }), $(".mobile-nav").on("click", function() {
            $("ul.navbar-nav.mr-auto .top-header__languages").prependTo(".top-header__dropdowns"), $("ul.navbar-nav.mr-auto .top-header__currency").prependTo(".top-header__dropdowns"), $(".modal-nav-list").fadeIn(100), $(".modal-nav-list").animate({'margin-left':'-15px'},100), $(".top-header__overlay").fadeIn(100), $("html").addClass("show-menu"), $(document).mouseup(function(e) {
