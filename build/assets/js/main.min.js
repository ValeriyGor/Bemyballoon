$(function() {
    ...
    $(document).ready(function() {
        ...
        $( window ).resize(function() {
         ...
         $.fn.AddXbutton = function(e) {
            ...
            $(".top-header__search-conteiner").addClass('opened'),$(".top-header__search-result").fadeIn(0), $('.searchInput').focus(), $("body .overlay").fadeIn(200), $("body").addClass("open-search");
            ...
            var o = $(this),
                ...
                a = $("#mobile-category"),
                n = a.find("> ul");
            o.hasClass("active") || (o.addClass("active"), a.addClass("relative"), n.addClass("mobile_list"), t.addClass("open"), $("body .overlay").show(), n.stop().slideDown(300), $("body").addClass("show-category"), $(document).mouseup(function(e) {
                0 === $(".mobile-category-menu").has(e.target).length && n.stop().slideUp(300, function() {
                    o.removeClass("active"), a.removeClass("relative"), n.removeClass("mobile_list"), t.removeClass("open"), $("body .overlay").hide(), $("body").removeClass("show-category")
                })
            }))
            ...
            o.hasClass("open") ? (t.removeClass("show"), o.removeClass("open"), t.slideUp(0)) : (t.addClass("show"), o.addClass("open")), $(document).mouseup(function(e) {
    ...
    $(".dropdown-hover" ).click(function() {
        if ($(window).width() < 1200) 
        {
            $(this).children('.dropdown-menu').stop().fadeToggle(150);
        }
    });
    ...
    $(".description__read-more").click(function(e) {
        ...
        var text = $(this).text();
        $(this).text(
        text == "Read more..." ? "Hide text" : "Read more...");
    });
