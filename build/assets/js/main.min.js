$(function() {
    ...
    $(document).ready(function() {
        $(".carousel .carousel-inner").slick({
            ...
            $(".top-header__search-result").fadeIn(300), $('.searchInput').focus(), $("body .overlay").show(), $("body").addClass("open-search"), $(document).mouseup(function(e) {
            ...
            text == "See all ocassions <span>7 more</span>" ? "Hide ocassions" : "See all ocassions <span>7 more</span>");
    ...
    $(".product-options__close").click(function(e) {
        e.preventDefault();
