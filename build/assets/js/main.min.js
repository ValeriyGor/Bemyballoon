$(function() {
    ...
    $(document).ready(function() {
        $(".carousel .carousel-inner").slick({
            ...
            $(".top-header__search-result").fadeIn(300), $('.searchInput').focus(), $("body .overlay").fadeIn(200), $("body").addClass("open-search");
            ...
            var text = $(this).text();
            $(this).text(text == "Add to cart" ? "Item added" : "Add to cart");
