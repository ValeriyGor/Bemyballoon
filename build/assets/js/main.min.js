$(function() {
    ...
    function o() {
        var e = $(".top-header__logo").height(),
            o = $(".top-header__dropdowns").height();
        0 == o && (o = 50);
        var t = $(window).height() - o - e;
        $(".top-header__links").css("max-height", t)
    }
    ...
    $(document).ready(function() {
        $(".carousel .carousel-inner").slick({
        ...
        }), $(".top-header__search a").on("click", function(e) {
            $(".top-header__search-result").fadeIn(300), $("body .overlay").show(), $("body").addClass("open-search"), $(document).mouseup(function(e) {
                var o = $(".top-header__search-result");
                0 === o.has(e.target).length && (o.hide(), $("body .overlay").hide(), $("body").removeClass("open-search"))
            }), e.preventDefault()
        }), $(".top-header__cart").on("click", function(e) {
            $(".top-header__cart-mini").show(), $("body .overlay").show(), $("body").addClass("open-search"), $(document).mouseup(function(e) {
                var o = $(".top-header__cart-mini");
                0 === o.has(e.target).length && (o.hide(), $("body .overlay").hide(), $("body").removeClass("open-search"))
            }), e.preventDefault()
            ...
            e.preventDefault(), $(this).addClass("added"), $(this).text("Item added")
        ...
        }), $(".ocassions__bottom-all").on("click", function(e) {
            e.preventDefault(), $(".ocassions__content > div").slideDown(), $(this).closest(".ocassions__bottom").remove()
        }), $(document).on("click", ".mobile-category", function(e) {
            e.preventDefault();
            var o = $(this),
                t = o.find(".show_category"),
                s = o.find(".hide_category"),
                a = $("#mobile-category"),
                n = a.find("> ul");
            o.hasClass("active") || (o.addClass("active"), a.addClass("relative"), n.addClass("mobile_list"), t.hide(), s.show(), $("body .overlay").show(), n.stop().slideDown(300), $("body").addClass("show-category"), $(document).mouseup(function(e) {
                0 === $(".mobile-category-menu").has(e.target).length && n.stop().slideUp(300, function() {
                    o.removeClass("active"), a.removeClass("relative"), n.removeClass("mobile_list"), t.show(), s.hide(), $("body .overlay").hide(), $("body").removeClass("show-category")
                })
            }))
        }), $(".mobile-nav").on("click", function() {
            $("ul.navbar-nav.mr-auto .top-header__languages").prependTo(".top-header__dropdowns"), $("ul.navbar-nav.mr-auto .top-header__currency").prependTo(".top-header__dropdowns"), $(".modal-nav-list").show(100), $(".top-header__overlay").show(100), $("html").addClass("show-menu"), $(document).mouseup(function(e) {
                var o = $(".modal-nav-list");
                0 === o.has(e.target).length && (o.hide(100), $(".top-header__overlay").hide(100), $("html").removeClass("show-menu"))
            })
            ...
            o.hasClass("open") ? (t.removeClass("show"), o.removeClass("open")) : (t.addClass("show"), o.addClass("open")), $(document).mouseup(function(e) {
                0 === o.has(e.target).length && (t.removeClass("show"), o.removeClass("open"))
            })
        })
    }), $(document).ready(function() {
        e(), o(), t()
    ...
    $( ".history-list__text ul" ).each(function() { 
        ...
        if(n>2){
        $(this).parent().append("<p class='button-open-list'>Read more..</p>");
    ...
    $(".add-address").click(function() {
        var n = $("#inputs-list").children('input').length;
        if(n<2){
            $("#inputs-list").append('<input type="text" />');
            $('.two-inps').show();
        }
        else{
            $("#inputs-list").append('<input type="text" />');
